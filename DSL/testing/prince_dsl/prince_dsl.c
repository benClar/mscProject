...
return ((~D & B & ~A) | (C & B & ~A) | (~D & ~C & ~B) | (~C & ~B & A) | (~D & C & B) | (D & ~B & A));
}
...
uint32_t temp_7_rnge[(15 - 0) + 1];
extract_bs_range(temp_7_rnge, state, 0, 15);
m0(temp_7_rnge, output);
uint32_t temp_8_rnge[(15 - 0) + 1];
extract_bs_range(temp_8_rnge, output, 0, 15);
state[0] = temp_8_rnge[0];
state[1] = temp_8_rnge[1];
state[2] = temp_8_rnge[2];
state[3] = temp_8_rnge[3];
state[4] = temp_8_rnge[4];
state[5] = temp_8_rnge[5];
state[6] = temp_8_rnge[6];
state[7] = temp_8_rnge[7];
state[8] = temp_8_rnge[8];
state[9] = temp_8_rnge[9];
state[10] = temp_8_rnge[10];
state[11] = temp_8_rnge[11];
state[12] = temp_8_rnge[12];
state[13] = temp_8_rnge[13];
state[14] = temp_8_rnge[14];
state[15] = temp_8_rnge[15];
uint32_t temp_9_rnge[(31 - 16) + 1];
extract_bs_range(temp_9_rnge, state, 16, 31);
m1(temp_9_rnge, output);
uint32_t temp_10_rnge[(15 - 0) + 1];
extract_bs_range(temp_10_rnge, output, 0, 15);
state[16] = temp_10_rnge[0];
state[17] = temp_10_rnge[1];
state[18] = temp_10_rnge[2];
state[19] = temp_10_rnge[3];
state[20] = temp_10_rnge[4];
state[21] = temp_10_rnge[5];
state[22] = temp_10_rnge[6];
state[23] = temp_10_rnge[7];
state[24] = temp_10_rnge[8];
state[25] = temp_10_rnge[9];
state[26] = temp_10_rnge[10];
state[27] = temp_10_rnge[11];
state[28] = temp_10_rnge[12];
state[29] = temp_10_rnge[13];
state[30] = temp_10_rnge[14];
state[31] = temp_10_rnge[15];
uint32_t temp_11_rnge[(47 - 32) + 1];
extract_bs_range(temp_11_rnge, state, 32, 47);
m1(temp_11_rnge, output);
uint32_t temp_12_rnge[(15 - 0) + 1];
extract_bs_range(temp_12_rnge, output, 0, 15);
state[32] = temp_12_rnge[0];
state[33] = temp_12_rnge[1];
state[34] = temp_12_rnge[2];
state[35] = temp_12_rnge[3];
state[36] = temp_12_rnge[4];
state[37] = temp_12_rnge[5];
state[38] = temp_12_rnge[6];
state[39] = temp_12_rnge[7];
state[40] = temp_12_rnge[8];
state[41] = temp_12_rnge[9];
state[42] = temp_12_rnge[10];
state[43] = temp_12_rnge[11];
state[44] = temp_12_rnge[12];
state[45] = temp_12_rnge[13];
state[46] = temp_12_rnge[14];
state[47] = temp_12_rnge[15];
uint32_t temp_13_rnge[(63 - 48) + 1];
extract_bs_range(temp_13_rnge, state, 48, 63);
m0(temp_13_rnge, output);
uint32_t temp_14_rnge[(15 - 0) + 1];
extract_bs_range(temp_14_rnge, output, 0, 15);
state[48] = temp_14_rnge[0];
state[49] = temp_14_rnge[1];
state[50] = temp_14_rnge[2];
state[51] = temp_14_rnge[3];
state[52] = temp_14_rnge[4];
state[53] = temp_14_rnge[5];
state[54] = temp_14_rnge[6];
state[55] = temp_14_rnge[7];
state[56] = temp_14_rnge[8];
state[57] = temp_14_rnge[9];
state[58] = temp_14_rnge[10];
state[59] = temp_14_rnge[11];
state[60] = temp_14_rnge[12];
state[61] = temp_14_rnge[13];
state[62] = temp_14_rnge[14];
state[63] = temp_14_rnge[15];
}
void sBox_layer(uint32_t state[64]){ 
uint8_t i;
i = 0;
for(;i < 16;) { 
uint32_t temp_16_rnge[(((i * 4) + 3) - (i * 4)) + 1];
extract_bs_range(temp_16_rnge, state, (i * 4), ((i * 4) + 3));
prince(temp_16_rnge);
uint8_t temp_20_init = 0;
uint32_t temp_21_rnge_size = 0;
temp_21_rnge_size = (((i * 4) + 3)-(i * 4)) + 1;
uint8_t temp_26_rng_start = (i * 4);
for(temp_20_init = 0; temp_20_init < temp_21_rnge_size; temp_20_init++, temp_26_rng_start++){
state[temp_26_rng_start] = temp_16_rnge[temp_20_init];
}
i = (i + 1);
} 
}
...
i = 0;
for(;i < 16;) { 
uint32_t temp_28_rnge[(((i * 4) + 3) - (i * 4)) + 1];
extract_bs_range(temp_28_rnge, state, (i * 4), ((i * 4) + 3));
prince_inv(temp_28_rnge);
uint8_t temp_32_init = 0;
uint32_t temp_33_rnge_size = 0;
temp_33_rnge_size = (((i * 4) + 3)-(i * 4)) + 1;
uint8_t temp_38_rng_start = (i * 4);
for(temp_32_init = 0; temp_32_init < temp_33_rnge_size; temp_32_init++, temp_38_rng_start++){
state[temp_38_rng_start] = temp_28_rnge[temp_32_init];
}
i = (i + 1);
} 
}
void  shift_rows(uint32_t *temp_39_bs_return, uint32_t state[64], uint8_t inverse){ 
uint8_t target;
target = 0;
uint32_t output[64] = {0};
uint32_t temp_40_rnge[(63 - 59) + 1];
extract_bs_range(temp_40_rnge, state, 59, 63);
output[59] = temp_40_rnge[0];
output[60] = temp_40_rnge[1];
output[61] = temp_40_rnge[2];
output[62] = temp_40_rnge[3];
output[63] = temp_40_rnge[4];
uint8_t nibble;
nibble = 1;
for(;nibble < 16;) { 
if(inverse == 1) { 
...
uint32_t temp_46_rnge[((63 - (nibble * 4)) - ((63 - (nibble * 4)) - 3)) + 1];
extract_bs_range(temp_46_rnge, state, ((63 - (nibble * 4)) - 3), (63 - (nibble * 4)));
uint8_t temp_52_init = 0;
uint32_t temp_53_rnge_size = 0;
temp_53_rnge_size = ((63 - (target * 4))-((63 - (target * 4)) - 3)) + 1;
uint8_t temp_62_rng_start = ((63 - (target * 4)) - 3);
for(temp_52_init = 0; temp_52_init < temp_53_rnge_size; temp_52_init++, temp_62_rng_start++){
output[temp_62_rng_start] = temp_46_rnge[temp_52_init];
}
nibble = (nibble + 1);
} 
temp_39_bs_return[0] = output[0];
temp_39_bs_return[1] = output[1];
temp_39_bs_return[2] = output[2];
temp_39_bs_return[3] = output[3];
temp_39_bs_return[4] = output[4];
temp_39_bs_return[5] = output[5];
temp_39_bs_return[6] = output[6];
temp_39_bs_return[7] = output[7];
temp_39_bs_return[8] = output[8];
temp_39_bs_return[9] = output[9];
temp_39_bs_return[10] = output[10];
temp_39_bs_return[11] = output[11];
temp_39_bs_return[12] = output[12];
temp_39_bs_return[13] = output[13];
temp_39_bs_return[14] = output[14];
temp_39_bs_return[15] = output[15];
temp_39_bs_return[16] = output[16];
temp_39_bs_return[17] = output[17];
temp_39_bs_return[18] = output[18];
temp_39_bs_return[19] = output[19];
temp_39_bs_return[20] = output[20];
temp_39_bs_return[21] = output[21];
temp_39_bs_return[22] = output[22];
temp_39_bs_return[23] = output[23];
temp_39_bs_return[24] = output[24];
temp_39_bs_return[25] = output[25];
temp_39_bs_return[26] = output[26];
temp_39_bs_return[27] = output[27];
temp_39_bs_return[28] = output[28];
temp_39_bs_return[29] = output[29];
temp_39_bs_return[30] = output[30];
temp_39_bs_return[31] = output[31];
temp_39_bs_return[32] = output[32];
temp_39_bs_return[33] = output[33];
temp_39_bs_return[34] = output[34];
temp_39_bs_return[35] = output[35];
temp_39_bs_return[36] = output[36];
temp_39_bs_return[37] = output[37];
temp_39_bs_return[38] = output[38];
temp_39_bs_return[39] = output[39];
temp_39_bs_return[40] = output[40];
temp_39_bs_return[41] = output[41];
temp_39_bs_return[42] = output[42];
temp_39_bs_return[43] = output[43];
temp_39_bs_return[44] = output[44];
temp_39_bs_return[45] = output[45];
temp_39_bs_return[46] = output[46];
temp_39_bs_return[47] = output[47];
temp_39_bs_return[48] = output[48];
temp_39_bs_return[49] = output[49];
temp_39_bs_return[50] = output[50];
temp_39_bs_return[51] = output[51];
temp_39_bs_return[52] = output[52];
temp_39_bs_return[53] = output[53];
temp_39_bs_return[54] = output[54];
temp_39_bs_return[55] = output[55];
temp_39_bs_return[56] = output[56];
temp_39_bs_return[57] = output[57];
temp_39_bs_return[58] = output[58];
temp_39_bs_return[59] = output[59];
temp_39_bs_return[60] = output[60];
temp_39_bs_return[61] = output[61];
temp_39_bs_return[62] = output[62];
temp_39_bs_return[63] = output[63];
}
...
shift_rows(temp_65_call, state, 0);
...
shift_rows(temp_67_call, state, 1);
