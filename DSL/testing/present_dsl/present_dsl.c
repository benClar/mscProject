...
return ((~C & ~B & A) | (~C & B & ~A) | (D & ~B & A) | (~D & ~C & ~B) | (D & C & ~B) | (~D & C & B & A));
}
uint32_t present_3(uint32_t A, uint32_t B, uint32_t C, uint32_t D) {
return ((~D & C & B) | (~D & ~B & ~A) | (D & ~C & B) | (~D & B & A) | (D & ~C & A) | (~D & C & ~A));
}
...
uint32_t  temp_30_extracted[64];
temp_30_extracted[0] = round_keys[round][0];
temp_30_extracted[1] = round_keys[round][1];
temp_30_extracted[2] = round_keys[round][2];
temp_30_extracted[3] = round_keys[round][3];
temp_30_extracted[4] = round_keys[round][4];
temp_30_extracted[5] = round_keys[round][5];
temp_30_extracted[6] = round_keys[round][6];
temp_30_extracted[7] = round_keys[round][7];
temp_30_extracted[8] = round_keys[round][8];
temp_30_extracted[9] = round_keys[round][9];
temp_30_extracted[10] = round_keys[round][10];
temp_30_extracted[11] = round_keys[round][11];
temp_30_extracted[12] = round_keys[round][12];
temp_30_extracted[13] = round_keys[round][13];
temp_30_extracted[14] = round_keys[round][14];
temp_30_extracted[15] = round_keys[round][15];
temp_30_extracted[16] = round_keys[round][16];
temp_30_extracted[17] = round_keys[round][17];
temp_30_extracted[18] = round_keys[round][18];
temp_30_extracted[19] = round_keys[round][19];
temp_30_extracted[20] = round_keys[round][20];
temp_30_extracted[21] = round_keys[round][21];
temp_30_extracted[22] = round_keys[round][22];
temp_30_extracted[23] = round_keys[round][23];
temp_30_extracted[24] = round_keys[round][24];
temp_30_extracted[25] = round_keys[round][25];
temp_30_extracted[26] = round_keys[round][26];
temp_30_extracted[27] = round_keys[round][27];
temp_30_extracted[28] = round_keys[round][28];
temp_30_extracted[29] = round_keys[round][29];
temp_30_extracted[30] = round_keys[round][30];
temp_30_extracted[31] = round_keys[round][31];
temp_30_extracted[32] = round_keys[round][32];
temp_30_extracted[33] = round_keys[round][33];
temp_30_extracted[34] = round_keys[round][34];
temp_30_extracted[35] = round_keys[round][35];
temp_30_extracted[36] = round_keys[round][36];
temp_30_extracted[37] = round_keys[round][37];
temp_30_extracted[38] = round_keys[round][38];
temp_30_extracted[39] = round_keys[round][39];
temp_30_extracted[40] = round_keys[round][40];
temp_30_extracted[41] = round_keys[round][41];
temp_30_extracted[42] = round_keys[round][42];
temp_30_extracted[43] = round_keys[round][43];
temp_30_extracted[44] = round_keys[round][44];
temp_30_extracted[45] = round_keys[round][45];
temp_30_extracted[46] = round_keys[round][46];
temp_30_extracted[47] = round_keys[round][47];
temp_30_extracted[48] = round_keys[round][48];
temp_30_extracted[49] = round_keys[round][49];
temp_30_extracted[50] = round_keys[round][50];
temp_30_extracted[51] = round_keys[round][51];
temp_30_extracted[52] = round_keys[round][52];
temp_30_extracted[53] = round_keys[round][53];
temp_30_extracted[54] = round_keys[round][54];
temp_30_extracted[55] = round_keys[round][55];
temp_30_extracted[56] = round_keys[round][56];
temp_30_extracted[57] = round_keys[round][57];
temp_30_extracted[58] = round_keys[round][58];
temp_30_extracted[59] = round_keys[round][59];
temp_30_extracted[60] = round_keys[round][60];
temp_30_extracted[61] = round_keys[round][61];
temp_30_extracted[62] = round_keys[round][62];
temp_30_extracted[63] = round_keys[round][63];
bitslice_bitwise(temp_29__bin, state, temp_30_extracted, 64, "^");
...
uint32_t temp_31__bin[64] = {0};
uint32_t  temp_32_extracted[64];
temp_32_extracted[0] = round_keys[31][0];
temp_32_extracted[1] = round_keys[31][1];
temp_32_extracted[2] = round_keys[31][2];
temp_32_extracted[3] = round_keys[31][3];
temp_32_extracted[4] = round_keys[31][4];
temp_32_extracted[5] = round_keys[31][5];
temp_32_extracted[6] = round_keys[31][6];
temp_32_extracted[7] = round_keys[31][7];
temp_32_extracted[8] = round_keys[31][8];
temp_32_extracted[9] = round_keys[31][9];
temp_32_extracted[10] = round_keys[31][10];
temp_32_extracted[11] = round_keys[31][11];
temp_32_extracted[12] = round_keys[31][12];
temp_32_extracted[13] = round_keys[31][13];
temp_32_extracted[14] = round_keys[31][14];
temp_32_extracted[15] = round_keys[31][15];
temp_32_extracted[16] = round_keys[31][16];
temp_32_extracted[17] = round_keys[31][17];
temp_32_extracted[18] = round_keys[31][18];
temp_32_extracted[19] = round_keys[31][19];
temp_32_extracted[20] = round_keys[31][20];
temp_32_extracted[21] = round_keys[31][21];
temp_32_extracted[22] = round_keys[31][22];
temp_32_extracted[23] = round_keys[31][23];
temp_32_extracted[24] = round_keys[31][24];
temp_32_extracted[25] = round_keys[31][25];
temp_32_extracted[26] = round_keys[31][26];
temp_32_extracted[27] = round_keys[31][27];
temp_32_extracted[28] = round_keys[31][28];
temp_32_extracted[29] = round_keys[31][29];
temp_32_extracted[30] = round_keys[31][30];
temp_32_extracted[31] = round_keys[31][31];
temp_32_extracted[32] = round_keys[31][32];
temp_32_extracted[33] = round_keys[31][33];
temp_32_extracted[34] = round_keys[31][34];
temp_32_extracted[35] = round_keys[31][35];
temp_32_extracted[36] = round_keys[31][36];
temp_32_extracted[37] = round_keys[31][37];
temp_32_extracted[38] = round_keys[31][38];
temp_32_extracted[39] = round_keys[31][39];
temp_32_extracted[40] = round_keys[31][40];
temp_32_extracted[41] = round_keys[31][41];
temp_32_extracted[42] = round_keys[31][42];
temp_32_extracted[43] = round_keys[31][43];
temp_32_extracted[44] = round_keys[31][44];
temp_32_extracted[45] = round_keys[31][45];
temp_32_extracted[46] = round_keys[31][46];
temp_32_extracted[47] = round_keys[31][47];
temp_32_extracted[48] = round_keys[31][48];
temp_32_extracted[49] = round_keys[31][49];
temp_32_extracted[50] = round_keys[31][50];
temp_32_extracted[51] = round_keys[31][51];
temp_32_extracted[52] = round_keys[31][52];
temp_32_extracted[53] = round_keys[31][53];
temp_32_extracted[54] = round_keys[31][54];
temp_32_extracted[55] = round_keys[31][55];
temp_32_extracted[56] = round_keys[31][56];
temp_32_extracted[57] = round_keys[31][57];
temp_32_extracted[58] = round_keys[31][58];
temp_32_extracted[59] = round_keys[31][59];
temp_32_extracted[60] = round_keys[31][60];
temp_32_extracted[61] = round_keys[31][61];
temp_32_extracted[62] = round_keys[31][62];
temp_32_extracted[63] = round_keys[31][63];
bitslice_bitwise(temp_31__bin, state, temp_32_extracted, 64, "^");
state[0] = temp_31__bin[0];
state[1] = temp_31__bin[1];
state[2] = temp_31__bin[2];
state[3] = temp_31__bin[3];
state[4] = temp_31__bin[4];
state[5] = temp_31__bin[5];
state[6] = temp_31__bin[6];
state[7] = temp_31__bin[7];
state[8] = temp_31__bin[8];
state[9] = temp_31__bin[9];
state[10] = temp_31__bin[10];
state[11] = temp_31__bin[11];
state[12] = temp_31__bin[12];
state[13] = temp_31__bin[13];
state[14] = temp_31__bin[14];
state[15] = temp_31__bin[15];
state[16] = temp_31__bin[16];
state[17] = temp_31__bin[17];
state[18] = temp_31__bin[18];
state[19] = temp_31__bin[19];
state[20] = temp_31__bin[20];
state[21] = temp_31__bin[21];
state[22] = temp_31__bin[22];
state[23] = temp_31__bin[23];
state[24] = temp_31__bin[24];
state[25] = temp_31__bin[25];
state[26] = temp_31__bin[26];
state[27] = temp_31__bin[27];
state[28] = temp_31__bin[28];
state[29] = temp_31__bin[29];
state[30] = temp_31__bin[30];
state[31] = temp_31__bin[31];
state[32] = temp_31__bin[32];
state[33] = temp_31__bin[33];
state[34] = temp_31__bin[34];
state[35] = temp_31__bin[35];
state[36] = temp_31__bin[36];
state[37] = temp_31__bin[37];
state[38] = temp_31__bin[38];
state[39] = temp_31__bin[39];
state[40] = temp_31__bin[40];
state[41] = temp_31__bin[41];
state[42] = temp_31__bin[42];
state[43] = temp_31__bin[43];
state[44] = temp_31__bin[44];
state[45] = temp_31__bin[45];
state[46] = temp_31__bin[46];
state[47] = temp_31__bin[47];
state[48] = temp_31__bin[48];
state[49] = temp_31__bin[49];
state[50] = temp_31__bin[50];
state[51] = temp_31__bin[51];
state[52] = temp_31__bin[52];
state[53] = temp_31__bin[53];
state[54] = temp_31__bin[54];
state[55] = temp_31__bin[55];
state[56] = temp_31__bin[56];
state[57] = temp_31__bin[57];
state[58] = temp_31__bin[58];
state[59] = temp_31__bin[59];
state[60] = temp_31__bin[60];
state[61] = temp_31__bin[61];
state[62] = temp_31__bin[62];
state[63] = temp_31__bin[63];
return state;
}
