...
uint32_t temp_9__bin[80] = {0};
rotate_right(temp_9__bin, key, 61, 80);
key[0] = temp_9__bin[0];
key[1] = temp_9__bin[1];
key[2] = temp_9__bin[2];
key[3] = temp_9__bin[3];
...
key[8] = temp_9__bin[8];
key[9] = temp_9__bin[9];
key[10] = temp_9__bin[10];
key[11] = temp_9__bin[11];
key[12] = temp_9__bin[12];
key[13] = temp_9__bin[13];
key[14] = temp_9__bin[14];
key[15] = temp_9__bin[15];
key[16] = temp_9__bin[16];
key[17] = temp_9__bin[17];
key[18] = temp_9__bin[18];
key[19] = temp_9__bin[19];
key[20] = temp_9__bin[20];
key[21] = temp_9__bin[21];
key[22] = temp_9__bin[22];
key[23] = temp_9__bin[23];
key[24] = temp_9__bin[24];
key[25] = temp_9__bin[25];
key[26] = temp_9__bin[26];
key[27] = temp_9__bin[27];
key[28] = temp_9__bin[28];
key[29] = temp_9__bin[29];
key[30] = temp_9__bin[30];
key[31] = temp_9__bin[31];
key[32] = temp_9__bin[32];
key[33] = temp_9__bin[33];
key[34] = temp_9__bin[34];
key[35] = temp_9__bin[35];
key[36] = temp_9__bin[36];
key[37] = temp_9__bin[37];
key[38] = temp_9__bin[38];
key[39] = temp_9__bin[39];
key[40] = temp_9__bin[40];
key[41] = temp_9__bin[41];
key[42] = temp_9__bin[42];
key[43] = temp_9__bin[43];
key[44] = temp_9__bin[44];
key[45] = temp_9__bin[45];
key[46] = temp_9__bin[46];
key[47] = temp_9__bin[47];
key[48] = temp_9__bin[48];
key[49] = temp_9__bin[49];
key[50] = temp_9__bin[50];
key[51] = temp_9__bin[51];
key[52] = temp_9__bin[52];
key[53] = temp_9__bin[53];
key[54] = temp_9__bin[54];
key[55] = temp_9__bin[55];
key[56] = temp_9__bin[56];
key[57] = temp_9__bin[57];
key[58] = temp_9__bin[58];
key[59] = temp_9__bin[59];
key[60] = temp_9__bin[60];
key[61] = temp_9__bin[61];
key[62] = temp_9__bin[62];
key[63] = temp_9__bin[63];
key[64] = temp_9__bin[64];
key[65] = temp_9__bin[65];
key[66] = temp_9__bin[66];
key[67] = temp_9__bin[67];
key[68] = temp_9__bin[68];
key[69] = temp_9__bin[69];
key[70] = temp_9__bin[70];
key[71] = temp_9__bin[71];
key[72] = temp_9__bin[72];
key[73] = temp_9__bin[73];
key[74] = temp_9__bin[74];
key[75] = temp_9__bin[75];
key[76] = temp_9__bin[76];
key[77] = temp_9__bin[77];
key[78] = temp_9__bin[78];
key[79] = temp_9__bin[79];
uint32_t temp_10_rnge[(79 - 76) + 1];
extract_bs_range(temp_10_rnge, key, 76, 79);
present(temp_10_rnge);
key[76] = temp_10_rnge[0];
key[77] = temp_10_rnge[1];
key[78] = temp_10_rnge[2];
key[79] = temp_10_rnge[3];
uint32_t temp_11__bin[(19 - 15) + 1] = {0};
uint32_t temp_12_rnge[(19 - 15) + 1];
extract_bs_range(temp_12_rnge, key, 15, 19);
uint8_t  temp_13_extracted = 0;
uint8_t temp_14_int_rng_start  = 0;
uint8_t  temp_16_target_bit = 0;
for(;temp_14_int_rng_start < 5;temp_14_int_rng_start++, temp_16_target_bit++){
temp_13_extracted |= ((round >> temp_14_int_rng_start)  << temp_16_target_bit);
}
uint32_t temp_17_casted_bs[(19 - 15) + 1];
int_to_bitsliced(temp_17_casted_bs, temp_13_extracted, (19 - 15) + 1);
XOR(temp_11__bin, temp_12_rnge, temp_17_casted_bs, 80);
key[15] = temp_11__bin[0];
key[16] = temp_11__bin[1];
key[17] = temp_11__bin[2];
key[18] = temp_11__bin[3];
key[19] = temp_11__bin[4];
round = (round + 1);
} 
}
...
uint8_t temp_35_init = 0;
uint32_t temp_36_rnge_size = 0;
temp_36_rnge_size = (((i * 4) + 3)-(i * 4)) + 1;
uint8_t temp_41_rng_start = (i * 4);
for(temp_35_init = 0; temp_35_init < temp_36_rnge_size; temp_35_init++, temp_41_rng_start++){
state[temp_41_rng_start] = temp_25_rnge[temp_35_init];
}
i = (i + 1);
} 
}
