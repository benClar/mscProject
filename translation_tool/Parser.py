...
class TestParser(unittest.TestCase):
    ...
    def test_bs_decl_parsing(self):
        par = Parser()
        self.assertEqual(par.parse_test_unit("@Int(10) varName;")[1], True)
        self.assertEqual(par.parse_test_unit("@Int(10)[10] varName;")[1], True)
        self.assertEqual(par.parse_test_unit("@Int(10)[10][10] varName;")[1], True)
    ...
    def test_seq_decl_parsing(self):
        par = Parser()
        self.assertEqual(par.parse_test_unit("@Int(10)[4] a = [1,2,3,4];")[1], True)
    ...
    def test_function_dec_parsing(self):
        par = Parser()
        self.assertEqual(par.parse_test_integration("Int(10) function_1(Int(10) a, Bit b) { Int(10) a = 1; Int(10) b = 2; }")[1], True)

    def test_index_select_parsing(self):
        par = Parser()
        self.assertEqual(par.parse_test_unit("((Int(10)[4]) a)[3];")[1], True)
...
class TestASTTree(unittest.TestCase):
    ...
    def test_int_decl(self):
        ...
        self.assertEqual(par.AST.tree[0].value.expressions[0].expressions[2].target.expressions[0].ID, "function")
    ...
    def test_bs_decl(self):
        ...
        self.assertEqual(par.parse_test_unit("Bit[10] varName;")[1], True)
    ...
    def test_int_seq_decl(self):
        ...
        self.assertEqual(par.AST.tree[0].ID, "a")
        ...
        self.assertEqual(par.AST.tree[6].value.expressions[0].ID, "b")
    ...
    def test_bit_seq_decl(self):
        ...
        self.assertEqual(par.parse_test_unit("Bit[1] b;")[1], True)
        self.assertEqual(par.AST.tree[0].node_type, AST_TYPE.SEQ_BIT_DECL)
    ...
    def test_func_decl(self):
        par = Parser()
        self.assertEqual(par.parse_test_integration("Bit function_1(Int(5) a, Bit b, Int(5)[4][4][4] test, Bit[5] b) { Int(10) a = 1; Int(10) b = 2; Int(10) c = 0xa; }")[1], True)  # NOQA
...
class TestSemanticAnalysisTree(unittest.TestCase):
    ...
    def test_for_loop(self):
        ...
        par = Parser()
        self.assertEqual(par.analyse_tree_test(par.parse_test_AST_semantic("Bit b; for(Int(10) i = 5; b != True; i = i + 5) { b = True; } b = 10;")), False)

    def test_func_decl(self):
        par = Parser()
        self.assertEqual(par.analyse_tree_test(par.parse_test_AST_semantic("Int(8) test_func(Int(8) a) { Int(10) d = 1;  Bit b = False; }")), True)
        self.assertEqual(par.semantic_analyser.sym_table.f_table['test_func']['return_type'], AST_TYPE.INT_VAL)

    def test_func_call(self):
        par = Parser()
        self.assertEqual(par.analyse_tree_test(par.parse_test_AST_semantic("Int(10) test_func(Int(10) a) { Int(10) d = test_func(test_func(10)) + 20; }")), True)
        par = Parser()
        self.assertEqual(par.analyse_tree_test(par.parse_test_AST_semantic("Bit test_func(Int(10) a) { Int(10) d = 10; }")), True)
        par = Parser()
        self.assertEqual(par.analyse_tree_test(par.parse_test_AST_semantic("Bit test_func1(Int(10) a) { a = a + 10; }\
