...
class Parser(object):
    ...
    def __init__(self):
        ...
        self.function_decl = Group((Group(self.int_size) ^ self.bit_ ^ self.seq_ ^ self.void_)("return_type") + Group(self.ID) +
...
class TestASTTree(unittest.TestCase):
    ...
    def test_func_decl(self):
        par = Parser()
        self.assertEqual(par.parse_test_integration("Int function_1(Int(5) a, Bit b) { Int(10) a = 1; Int(10) b = 2; Int(10) c = 0xa; }")[1], True)
